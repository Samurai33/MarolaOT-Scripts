...
| Skills | `skills/*/SKILL.md` | On invocation or relevance | Repeatable procedures |
...
3. Review `CLAUDE.md`, `.claude/settings.json`, skills, agents, and any hooks.
...
8. Keep hooks disabled initially; follow `hooks/README.md` to opt in.
9. Start work from a GitHub issue.
